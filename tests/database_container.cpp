...
// TEST(ContainerTests,canStoreAndRetrieveAllDataBasedOnCriteria)
// {
//   std::map<std::string,std::string> schema = {
//     {"p_id","std::size_t"},
//     {"p_name","database::ComparableString"},
...
//   std::map<std::string,std::vector<database::ComparableString>> query_result = database::TransactionFactory::SelectWithCriteriaFrom(container,{{"p_country",(std::string)"DE"}},{database::ValueComparisonType::equal_to},{});
//   std::map<std::string,std::vector<database::ComparableString>> expected_result = {
